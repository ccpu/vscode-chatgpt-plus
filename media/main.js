  ...
  window.addEventListener('message', (event) => {
    ...
    switch (message.type) {
      ...
      case 'addError':
        ...
        list.innerHTML += `<div class="p-4 self-end mt-2 pb-4 error-element-gnc">
                        <h2 class="font-bold mb-5 flex">${aiSvg}ChatGPT</h2>
                        <div class="text-red-400">${marked.parse(
                          'An error occurred. Try to restart your Visual Studio Code. If you still experience issues, it may be due to outage on https://openai.com services.'
                        )}</div>
                    </div>`;
