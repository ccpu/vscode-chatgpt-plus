...
(function () {
    ...
    const retrySvg = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
        ...
        switch (message.type) {
            ...
            case "addResponse":
                ...
                preCodeList.forEach((preCode, index) => {
                    ...
                    copyButton.classList.add("code-element-gnc", "p-1.5", "flex", "items-center", "rounded-lg");

                    const insert = document.createElement("button");
                    insert.title = "Insert the below code to the current file";
                    insert.innerHTML = insertSvg;

                    insert.classList.add("edit-element-gnc", "p-1.5", "flex", "items-center", "rounded-lg");

                    const newTab = document.createElement("button");
                    newTab.title = "Create a new file with the below code";
                    newTab.innerHTML = plusSvg;

                    newTab.classList.add("new-code-element-gnc", "p-1.5", "flex", "items-center", "rounded-lg");
                ...
                list.innerHTML +=
                    `<div class="p-4 self-end mt-2 pb-1 answer-element-gnc">
